...
public class Practicum {
    ...
    private static void printOrderedByDateReceived(Set<Letter> letters) {
        ...
        // Создаем TreeSet с компаратором для сортировки по дате получения
        TreeSet<Letter> sortedLetters = new TreeSet<>(Comparator.comparing(l -> l.dateReceived));

        // Заполняем TreeSet данными
        sortedLetters.addAll(letters);

        // Выводим отсортированные письма
