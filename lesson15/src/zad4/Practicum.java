...
public class Practicum {
    public static void main(String[] args) {
        // Создаем TreeSet с компаратором для сортировки по цене
        Set<Ticket> tickets = new TreeSet<>(new Comparator<Ticket>() {
            @Override
            public int compare(Ticket o1, Ticket o2) {
                return Integer.compare(o1.priceInUsd, o2.priceInUsd);
            }
        });
