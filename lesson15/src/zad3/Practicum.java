...
public class Practicum {
    public static void main(String[] args) {
        Set<String> songs = new LinkedHashSet<>(); // Используем LinkedHashSet для сохранения порядка
        fillSongs(songs);
    ...
    private static void fillSongs(Set<String> songs) {
        ...
        songs.add("Gorillaz – Clint Eastwood"); // Дубликат
        songs.add("Lady Gaga – Bad Romance");   // Дубликат
        songs.add("Bruno Mars – Talking To The Moon");
        songs.add("Taylor Swift – Wildest Dreams"); // Дубликат
    }
}
